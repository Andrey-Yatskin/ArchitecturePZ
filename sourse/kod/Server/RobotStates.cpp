    ...
    if (charge > 0 && charge <= 100)
    {
        ...
        case Estate::On:
            if (e.event == waiting_command)
            {
                ...
                system->waiting();
                cout << "Ñîñòîÿíèå: " << state << " -- Waiting" << endl;
            }
            else if (e.event == on_error)
            {
                state = Estate::Error;
                cout << "Ñîñòîÿíèå: " << state << " -- Error" << endl;
            }
            break;
        case Estate::waiting:
            if (e.event == press_stop1)
            {
                state = Estate::Off;
                system->press_stop();
                cout << "Ñîñòîÿíèå: " << state << " -- Off" << endl;
            }
            else if (e.event == receive_move)
            {
                state = Estate::move_forward;
                system->move();
                cout << "Ñîñòîÿíèå: " << state << " -- Moving forward" << endl;
            }
            break;
        case Estate::move_forward:
            if (e.event == receive_turn)
            {
                ...
                system->turning();
                cout << "Ñîñòîÿíèå: " << state << " -- Turn left" << endl;
            }
        ...
        case Estate::turn_left:
            if (e.event == set_hand)
            {
                ...
                system->setHand();
                cout << "Ñîñòîÿíèå: " << state << " -- Setting hand" << endl;
            }
        ...
        case Estate::settingHand:
            if (e.event == receive_spray)
            {
                ...
                system->do_spray();
                cout << "Ñîñòîÿíèå: " << state << " -- Spraying" << endl;
            }
